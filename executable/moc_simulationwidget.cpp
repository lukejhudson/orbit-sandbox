...
#include "../../orbit-sandbox/simulationwidget.h"
...
QT_MOC_LITERAL(1, 17, 14), // "gameOverSignal"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "SimulationWidget\0gameOverSignal\0"
};
...
void SimulationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SimulationWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationWidget::gameOverSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SimulationWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SimulationWidget.data,
      qt_meta_data_SimulationWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SimulationWidget::gameOverSignal()
{
